...
{
    add_menu_page('共通設定画面', 'メニュー項目名設定', 'manage_options', 'menu_setting_page', 'menu_setting_page', 'dashicons-admin-generic', 40);
...
function add_menu_setting()
{
		...
		register_setting('menu-settings-group', 'disc-text');
